...
// Function to check if philo died from not eating
...
// Monitoring thread
// Checks for 1) if any philosophers are dead, simulation ends
            //2) if all philosophers are full, simulation ends 
